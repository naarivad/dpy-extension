...
import re
#from .utils import db  # Pseudo ORM. Import only if you use https://github.com/darthshittious/Robo-VJ/blob/main/cogs/utils/db.py
...
### Define table using imported ORM
